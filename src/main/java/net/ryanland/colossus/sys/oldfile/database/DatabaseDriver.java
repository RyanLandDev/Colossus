...
import net.ryanland.colossus.sys.oldfile.provider.dProvider;
 ...
 * When creating your own, do not forget to create {@link dProvider Providers} for the (default pre-defined) values.
